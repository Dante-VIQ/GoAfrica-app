    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-2xl lg:text-4xl tracking-tight font-extrabold text-gray-600 dark:text-white">Daily
                    Read</h2>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4">Book A tour round Africa. We offer the best experirnces ranging from cultural
                        dances, festivals, nature walks, wildfire and many more</p>
