...
<x-app-layout>
    <div class="py-20">
        <div class="pt-16 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
                ...
                <article
                    ...
                    {{-- <div class="absolute top-2 right-2">
                        <div x-data="{ show: false }">
                            <x-button class="text-black" x-on:click.prevent="show = true">show<i
                                    class="fa fa-ellipsis text-3xl"></i></x-button>
                            <div class="h-auto w-24 bg-gray-dark">
                                <div x-show="show" x-on:click.outside.prevent="show = false">
                                    <ol class="right-4 bg-slate-800 text-slate-300 justify-center p-2">
                                        ...
                                        @endcan
                                        <li><a wire:click.live="delete({{ $blog->id }})" href="#">Delete</a>
                                        </li>
                    ...
                    @can('delete', $blog)
                        <x-button wire:click="delete({{ $blog->id }})">
                            Delete
                        </x-button>
                    @endcan
                    <header class="mb-4 lg:mb-6 not-format">
                        <address class="flex items-center mb-6 not-italic">
                            <div class="inline-grid items-center mr-3 text-sm text-gray-600 dark:text-white">
    ...
    <aside aria-label="Related articles" class="py-8 lg:py-24 bg-gray-50 dark:bg-gray-800">
        <div class="px-4 mx-auto max-w-screen-xl">
            ...
            <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <article wire:key="{{ $blog->id }}" class="max-w-xs">
                    <a href="#">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-400 h-32 max-h-screen">{{ $blog->description }}</p>
                    <a href="#"
        ...
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 <a href="#"
                        class="hover:underline">Mild™</a>. All Rights Reserved.
                </span>
