        ...
        <form wire:submit.prevent="create">
            ...
            <div class="flex space-x-2">
                <div class="mb-6 text-black font-semibold">
                    <label for="name" class="inline-block text-lg mb-2">Place</label>
                ...
                <div class="mb-6 text-black font-semibold">
                    <label for="department" class="inline-block text-lg mb-2">Price</label>
                    <input wire:model.live="department" type="number" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6 text-black font-semibold">
                ...
                <textarea wire:model.live="detail" type="number" class="border border-gray-200 rounded p-2 w-full"
